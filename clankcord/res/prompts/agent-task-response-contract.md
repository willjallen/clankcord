...
For other state-changing work, submit a concise visible response only when the command itself did not already deliver the requested user-visible result.
